...
var clozeCard = function(text, cloze) {
	this.cloze = cloze;
	this.text = text;
	this.partialText = text.replace(cloze, "______________");
	// constructor should throw or log an error when t_______________he cloze deletion does not appear in the input text.
